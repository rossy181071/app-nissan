...
export class Nissanmaxima extends LitElement {
  ...
  constructor() {
    ...
    this.paragraph2 = ' Suele estar alrededor de 3.5 litros.    '

    this.title3 = 'Potencia del motor:  '
    this.paragraph3 = 'Alrededor de 300 caballos de fuerza (hp), o aproximadamente 224 kilovatios (kW).   '

    this.title4 = 'Torque del motor:   '
    this.paragraph4 = '   Generalmente en el rango de 261 a 261 libras-pie, o aproximadamente 354 a 354 Newton metros.    '
    ...
    this.paragraph9 = ' El Maxima no está diseñado para remolcar cargas pesadas y generalmente no tiene capacidad de remolque significativa.    '

   
    this.Image1url = ' https://tse3.mm.bing.net/th?id=OIP.zEFOi51luCQzqs1xjWHmdwAAAA&pid=Api&P=0&h=180'
...
window.customElements.define('nissan-maxima', Nissanmaxima)
